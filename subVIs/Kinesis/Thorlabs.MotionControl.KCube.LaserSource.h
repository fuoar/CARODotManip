...
/// \endcond
	...
	{
		LS_SoftwareOnly = 0x00,///< Input is read from software only
		LS_ExternalSignal = 0x01,///<Input is read from External signal
		LS_WheelAndSoftware = 0x02,///<Input is read from software and Potentiometer
	} LS_InputSourceFlags;
