 ...
 *  This section details the Structures and Functions relavent to the  @ref MPCx20_page "Polarizer"<br />
...
extern "C"
{
	...
	typedef struct POL_Params
	{
		/// <summary> The velocity. </summary>
		unsigned short Velocity;
		/// <summary> The home position. </summary>
		unsigned short HomePosition;
		/// <summary> Size of the jog step. </summary>
		unsigned short JogSize;
		/// <summary> The reserved[2] bytes. </summary>
		WORD reserved[2];
	} POL_Params;
	...
	POLARIZERDLL_API POL_PaddleBits __cdecl MPC_GetEnabledPaddles();
	...
	/// <seealso cref="MPC_GetStepsPerDegree" />
    /// 		  \include CodeSnippet_move.cpp
	POLARIZERDLL_API int __cdecl MPC_GetMaxTravel(char const * serialNo);
	...
	/// <seealso cref="MPC_MoveToPosition(char const * serialNo, int index)" />
	...
	/// <seealso cref="MPC_GetStepsPerDegree" />
    /// 		  \include CodeSnippet_move.cpp
	POLARIZERDLL_API short __cdecl MPC_MoveToPosition(char const * serialNo, POL_Paddles paddle, int position);
	...
	/// <seealso cref="MPC_GetStepsPerDegree" />
    /// 		  \include CodeSnippet_move.cpp
	POLARIZERDLL_API short __cdecl MPC_MoveRelative(char const * serialNo, POL_Paddles paddle, short position);
	...
	/// <seealso cref="MPC_GetNumberPositions(char const * serialNo)" />
	/// <seealso cref="MPC_MoveToPosition(char const * serialNo, MPC_Positions index)" />
	/// <seealso cref="MPC_Home(char const * serialNo)" />
	/// <seealso cref="MPC_GetMaxTravel(char const * serialNo)" />
	/// <seealso cref="MPC_GetStepsPerDegree" />
    /// 		  \include CodeSnippet_move.cpp
	POLARIZERDLL_API int __cdecl MPC_GetPosition(char const * serialNo, POL_Paddles paddle);

	/// <summary> Request polarizer parameters. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="MPC_GetPolParams(char const * serialNo, POL_Params *polParams)" />
	/// <seealso cref="MPC_SetPolParams(char const * serialNo, POL_Params *polParams)" />
	/// <seealso cref="MPC_SetJogSize(char const * serialNo, POL_Paddles paddle, short jogSize)" />
	/// <seealso cref="MPC_GetJogSize(char const * serialNo, POL_Paddles paddle)" />
	/// <seealso cref="MPC_SetHomeOffset(char const * serialNo, short homeOffset)" />
	...
	/// <seealso cref="MPC_GetMaxTravel(char const * serialNo)" />
	/// <seealso cref="MPC_GetStepsPerDegree" />
	POLARIZERDLL_API short __cdecl MPC_GetPolParams(char const * serialNo, POL_Params *polParams);
	...
	/// <seealso cref="MPC_GetMaxTravel(char const * serialNo)" />
	/// <seealso cref="MPC_GetStepsPerDegree" />
	POLARIZERDLL_API short __cdecl MPC_SetPolParams(char const * serialNo, POL_Params *polParams);
	...
	/// <seealso cref="MPC_GetMaxTravel(char const * serialNo)" />
	/// <seealso cref="MPC_GetStepsPerDegree" />
	POLARIZERDLL_API short __cdecl MPC_SetJogSize(char const * serialNo, POL_Paddles paddle, short jogSize);
	...
	/// <seealso cref="MPC_GetMaxTravel(char const * serialNo)"/>
	/// <seealso cref="MPC_GetStepsPerDegree"/>
	POLARIZERDLL_API short __cdecl MPC_GetJogSize(char const * serialNo, POL_Paddles paddle);
	...
	/// <seealso cref="MPC_GetMaxTravel(char const * serialNo)" />
	/// <seealso cref="MPC_GetStepsPerDegree" />
	POLARIZERDLL_API short __cdecl MPC_SetHomeOffset(char const * serialNo, short homeOffset);
	...
	/// <seealso cref="MPC_GetMaxTravel(char const * serialNo)" />
	/// <seealso cref="MPC_GetStepsPerDegree" />
	POLARIZERDLL_API short __cdecl MPC_GetHomeOffset(char const * serialNo);
	...
	/// <seealso cref="MPC_GetPolParams(char const * serialNo, POL_Params *polParams)" />
	/// <seealso cref="MPC_SetPolParams(char const * serialNo, POL_Params *polParams)" />
	/// <seealso cref="MPC_SetJogSize(char const * serialNo, short jogSize)" />
	/// <seealso cref="MPC_GetVelocity(char const * serialNo)" />
